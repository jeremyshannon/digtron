...
digtron.award_item_dug = function (items_dropped, player)
	...
	if awards.get_item_count(data, "digtron_dug", "hades_core:mese_crystal") > 100 then
		awards.unlock(player, "digtron_100mese_dug")
	end
	if awards.get_item_count(data, "digtron_dug", "hades_core:diamond") > 100 then
		awards.unlock(player, "digtron_100diamond_dug")
	end
	if awards.get_item_count(data, "digtron_dug", "hades_core:coal_lump") > 1000 then
		awards.unlock(player, "digtron_1000coal_dug")
		if awards.get_item_count(data, "digtron_dug", "hades_core:coal_lump") > 10000 then
			awards.unlock(player, "digtron_10000coal_dug")
		end
	end
	if awards.get_item_count(data, "digtron_dug", "hades_core:iron_lump") > 1000 then
		awards.unlock(player, "digtron_1000iron_dug")
	end
	if awards.get_item_count(data, "digtron_dug", "hades_core:copper_lump") > 1000 then
		awards.unlock(player, "digtron_1000copper_dug")
	end
	if awards.get_item_count(data, "digtron_dug", "hades_core:gold_lump") > 100 then
